        ...
        if (KTUtil.hasClass(body, 'kt-aside--fixed')) {
            ...
            KTUtil.addEvent(aside, 'mouseenter', function(e) {
                ...
                insideTm = setTimeout(function() {
                    if (KTUtil.hasClass(body, 'kt-aside--minimize') && KTUtil.isInResponsiveRange('desktop')) {
                        ...
                        // Hover class
                        KTUtil.addClass(body, 'kt-aside--minimize-hover-disactive');
            ...
            KTUtil.addEvent(aside, 'mouseleave', function(e) {
                ...
                outsideTm = setTimeout(function() {
                    if (KTUtil.hasClass(body, 'kt-aside--minimize-hover-disactive') && KTUtil.isInResponsiveRange('desktop')) {
                        KTUtil.removeClass(body, 'kt-aside--minimize-hover-disactive');
