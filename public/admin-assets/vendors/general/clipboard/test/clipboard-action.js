...
describe('ClipboardAction', () => {
    ...
    describe('#set action', () => {
        it('should throw an errors since "action" is invalid', done => {
            try {
                new ClipboardAction({
                    text: 'foo',
                    action: 'paste'
    ...
    describe('#set target', () => {
        it('should throw an errors since "target" do not match any element', done => {
            try {
                new ClipboardAction({
    ...
    describe('#copyText', () => {
        ...
        it('should fire an errors event on browsers that support copy command', done => {
    ...
    describe('#handleResult', () => {
        ...
        it('should fire a errors event with certain properties', done => {
            let clip = new ClipboardAction({
                emitter: new Emitter(),
                container: document.body,
                target: document.querySelector('#input')
