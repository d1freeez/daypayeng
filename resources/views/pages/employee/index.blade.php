                    ...
                    <div class="kt-portlet__head">
                        ...
                        <div class="kt-portlet__head-toolbar">
                            @can('create', App\Models\Employee::class)
                                <a href="{{ route('employees.create') }}" class="btn btn-outline-brand js_create_modal" style="display: flex">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            @endcan
                                            <th>{{ __('table.without_verification') }}</th>
                                            <th>{{ __('table.active') }}</th>
                                            <th>{{ __('table.available_amount') }}</th>
                                        ...
                                        @forelse ($items as $item)
                                            <tr>
                                                ...
                                                @endcan
                                                <td>
                                                    <span class="kt-badge  {{ $item->without_checking == 1 ? 'kt-badge--success' : 'kt-badge--danger' }} kt-badge--inline kt-badge--rounded text-center text-white">{{ $item->without_checking == 1 ? 'Да' : 'Нет' }}</span>
                                                </td>
                                                <td>
                                                ...
                                                <td data-field="Actions" data-autohide-disabled="false" class="kt-datatable__cell">
                                                    <div class="dropdown dropdown-inline">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            @can('update', $item)
                                                                <a href="{{ route('employees.edit', $item) }}" class="dropdown-item">
                                                            ...
                                                            @endcan
                                                            @can('accrueAdvance', $item)
                                                                @if($item->verified)
                                                                    <a href="{{ route('employees.change.activity', $item) }}" class="dropdown-item">
                                                                ...
                                                                <button href="#" class="dropdown-item js_delete_modal"
                                                                        ...
                                                                        data-action="{{ route('employees.accrual.period', $item) }}">
                                                            ...
                                                            @can('delete', $item)
                                                                ...
                                                                <button href="#" class="dropdown-item js_delete_modal"
                                                                        ...
                                                                        data-action="{{ route('employees.destroy', $item) }}">
