                ...
                <div class="kt-login__body">
                    ...
                    <div class="kt-login__form">
                        <div class="kt-login__title">
                            <h3>{{ __('auth.create_password_to_account') }}</h3>
                        </div>

                        <!--begin::Form-->
                        <form class="kt-form" action="{{ route('reset_password_finish_post', ['token' => $token]) }}" method="POST">
                            ...
                            <div class="kt-login__actions">
                                ...
                                <button type="submit" class="btn btn-primary btn-elevate kt-login__btn-primary">{{ __('auth.send_req') }}</button>
                            </div>
