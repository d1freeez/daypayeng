...
<div class="kt-grid kt-grid--ver kt-grid--root">
    <div class="kt-grid kt-grid--hor kt-grid--root  kt-login kt-login--v1" id="kt_login">
        <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--desktop kt-grid--ver-desktop kt-grid--hor-tablet-and-mobile">
            ...
            <!--begin::Aside-->
            <div class="kt-grid__item kt-grid__item--order-tablet-and-mobile-2 kt-grid kt-grid--hor kt-login__aside kt-hidden-mobile" style="background-image: url({{ asset('images/banner/login-banner.png') }}); background-position:center;">
                <div class="kt-grid__item">
                    <a href="https://paydayservice.kz/" class="kt-link kt-link--state kt-link--danger kt-font-bolder">
                        <img src="{{ asset('images/logo/logo-white.png') }}" style="width: 175px;">
                    </a>
                </div>
            </div>
                ...
                <div class="kt-login__body">
                    ...
                    <div class="kt-login__form">
                        <div class="kt-login__title">
                            <h5>{{ __('auth.verify_code_sent') }} {{ __('auth.after') }} <span id="seconds"></span> {{ __('auth.will_be_redirect') }}</h5>
                        </div>
...
<script src="{{ asset('admin-assets/vendors/custom/components/vendors/bootstrap-datepicker/init.js') }}" type="text/javascript"></script>
...
<script src="{{ asset('admin-assets/vendors/custom/components/vendors/bootstrap-timepicker/init.js') }}" type="text/javascript"></script>
...
<script src="{{ asset('admin-assets/vendors/custom/components/vendors/bootstrap-markdown/init.js') }}" type="text/javascript"></script>
...
<script>
    time=20,r=document.getElementById('seconds'),tmp=time;
    setInterval(function(){
        var c=tmp--,m=(c/60)>>0,s=(c-m*60)+'';
        r.textContent=s
        tmp!=0||(location.replace("{{ route('login') }}"));
    },1000);
</script>
</body>
