    ...
    <div class="kt-content kt-grid__item kt-grid__item--fluid">
        <div class="row">
            <div class="col-sm-12">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            <th>#</th>
                                            <th>{{ __('table.name') }}</th>
                                            <th>{{ __('table.appointed_manager') }}</th>
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            @can('update', $item)
                                                                <button type="button"
                                                                        ...
                                                                        data-action="{{ route('departments.update', $item) }}"
                                                                        data-item="{{ route('departments.show', $item) }}">
                                                            ...
                                                            @can('delete', $item)
                                                                ...
                                                                <button href="#" class="dropdown-item js_delete_modal"
                                                                        ...
                                                                        data-action="{{ route('departments.destroy', $item) }}">
                ...
                @include('pages.lib.department._create')
                @include('pages.lib.department._update')
                @include('pages.lib.department._delete')
            </div>
        </div>
    </div>
@endsection
