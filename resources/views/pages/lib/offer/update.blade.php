        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="kt-portlet">
                    ...
                    <!--begin::Form-->
                    <form class="kt-form" action="{{ route('offers.update', $item) }}" method="post">
                            ...
                            <div class="kt-section kt-section--first">
                                <div class="kt-section__body row">
                                    <div class="form-group col-md-12 @error('title') validated @enderror">
                                        ...
                                        <input class="form-control @error('title') is-invalid @enderror" type="text" value="{{ $item->title }}" id="offer_title" name="title" >
                                        @error('title')
                                    ...
                                    <div class="form-group col-md-12 @error('description') validated @enderror">
                                        ...
                                        <textarea name="description" id="offer_description" class="form-control @error('description') is-invalid @enderror summernote" rows="40" >{!! $item->description !!}</textarea>
                                        @error('description')
                                            <div class="valid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
