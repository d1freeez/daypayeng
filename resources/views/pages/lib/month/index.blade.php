    ...
    <div class="kt-content kt-grid__item kt-grid__item--fluid">
        <div class="row">
            <div class="col-sm-12">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <th>{{ __('table.days') }}</th>
                                            <th>{{ __('table.w_days_five') }}</th>
                                            <th>{{ __('table.w_days_six') }}</th>
                                        ...
                                        @forelse ($items as $item)
                                            <tr>
                                                ...
                                                <td>{{ $item->month_dates }}</td>
                                                <td>{{ $item->five_working_days }}</td>
                                                <td>{{ $item->six_working_days }}</td>
                                                <td>
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            @can('update', $item)
                                                                <button type="button"
                                                                        ...
                                                                        data-action="{{ route('month.update', $item) }}"
                                                                        data-item="{{ route('month.show', $item) }}">
                                                            ...
                                                            @can('delete', $item)
                                                                ...
                                                                <button href="#" class="dropdown-item js_delete_modal"
                                                                        ...
                                                                        data-action="{{ route('month.destroy', $item) }}">
                ...
                @include('pages.lib.month._create')
                @include('pages.lib.month._update')
                @include('pages.lib.month._delete')
            </div>
        </div>
    </div>
@endsection
