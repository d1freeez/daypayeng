<template>
    <div>
        <div class="main__purple">
            <div class="main__purple__block_circle_left"></div>
            <div class="container">
                <div class="main__purple__block">
                    <div class="main__block_right -mobile">
                        <div class="main__block_right_four"><img src="/images/main-right-mobil-mb.png"></div>
                    </div>
                    <div class="main__purple__block_right -desktop">
                        <div class="main__purple__block_right_three" id="imgParallax"><img data-depth="0.8"
                                                                                           src="/images/main-right-loop.png">
                        </div>
                        <div class="main__purple__block_right_two" id="imgParallax1"><img data-depth="0.5"
                                                                                          src="/images/main-right-figures.png">
                        </div>
                        <div class="main__purple__block_right_one" id="imgParallax2"><img data-depth="0.9"
                                                                                          src="/images/main-right-mobile.png">
                        </div>
                    </div>
                    <div class="main__purple__block_left">
                        <Transition
                            appear
                            name="fadeRight"
                        >
            ...
            <div>
                <div class="main__purple__block_circle_right"></div>
                <div class="main__purple__block_footer">
                    <div class="container">
                        <img src="/images/main-block-footer.svg" alt="">
                    </div>
                </div>
            </div>
            <div class="main__purple__calendar_section">
                <div class="main__purple__calendar_circle_left"></div>
                <div class="container">
                    <div class="main__purple__block_calendar">
                        <div class="main__purple__block_calendar_img"><img
                    ...
                    <div class="main__problems_block">
                        ...
                        <div class="main__problems">
                            <div class="main__problem">
                                <div class="main__problem_title"><img src="/images/icons/ic-from-left.png"></div>
                                <div class="main__problem_subtitle">РАБОТНИКИ</div>
                                <div class="main__problem_description">которым срочно нужны деньги</div>
                            </div>
                            <div class="main__problem">
                ...
                <div class="what_is__section">
                    ...
                    <div class="container">
                        <div class="what_is__flex">
                                    ...
                                    <a href="#form">
                                        ...
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            ...
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                  ...
                                                  stroke="white" stroke-width="1.5" stroke-linecap="round"
                                                  stroke-linejoin="round"/>
                                            <path d="M10.5576 15.471L14.0436 12L10.5576 8.52901" stroke="white"
                            ...
                            <div class="what_is__image" id="imgParallax3">
            ...
            <div class="__requirements">
                <div class="container">
                    <div class="__takeit">
                        <div class="__takeit_title">
                            Вы получаете
                        </div>
                        <div class="__takeit_list">
                            <div class="__takeit_item">
                                <h5>Удобство</h5>
                                <p>Автоматизация устарелых норм получения заработной платы. Работник получает
                                    заработную
                                    плату тогда, когда ему требуется.</p>
                            </div>
                            <div class="__takeit_item">
                                <h5>Продуктивность</h5>
                                <p>Работник больше не нуждается в потребности брать деньги в долг и залезать в
                                    кредит.
                                    Если сотрудник не чувствует финансового стресса, его продуктивность
                                    возрастает.</p>
                            </div>
                            <div class="__takeit_item">
                                <h5>Экономию</h5>
                    ...
                    <div class="row __requirements_first_list">
                        <div class="col-md-4">
                            <div class="__requirements_item">
                                <div class="__requirements_item_image">
                                    <img src="/images/requirement_5.png"/>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="__requirements_item">
                                <div class="__requirements_item_image">
                                    <img src="/images/requirement_4.png"/>
                                </div>
                                <div class="__requirements_item_title">
                                    Смарт-документооборот базы трудовых договоров
                                </div>
                                <div class="__requirements_item_description">
                                    Подписание трудовых договоров в онлайн режиме, с последующем хранением
                                    договоров.
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="__requirements_item">
                                <div class="__requirements_item_image">
                                    <img src="/images/requirement_3.png"/>
                                </div>
                                <div class="__requirements_item_title">
                    ...
                    <div class="row __requirements_margin_top">
                        <div class="col-md-6">
                            <div class="__requirements_item">
                                <div class="__requirements_item_image">
                                    <img src="/images/requirement_1.png"/>
                                </div>
                                <div class="__requirements_item_title">
                                    Система повышения эффективности
                                </div>
                                <div class="__requirements_item_description">
                                    Вычисление эффективности каждого работника, отдела, всего предприятия.
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="__requirements_item">
                                <div class="__requirements_item_image">
                                    <img src="/images/requirement_2.png"/>
                                </div>
                                <div class="__requirements_item_title">
                                    Лояльность работников
                                </div>
                                <div class="__requirements_item_description">
                                    Решая финансовые проблемы работников работодатель повышает лояльность. к своей
                                    компании.
                                </div>
                            </div>
                        </div>
            ...
            <div class="form__block_out" id="form">
                <div class="form__block_cirle_left"></div>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="mass_media__item">
                                            <div>
                                                <div class="__title">
                                                    Будущее финансовых технологий: казахстанцы запустили инновационный
                                                    сервис
                                                </div>
                                                <div class="__description">
                                                    Новый сервис позволит облегчить долговую нагрузку работникам, а
                                                    компаниям –
                                    ...
                                    <div class="swiper-slide">
                                        <div class="mass_media__item">
                                            <div>
                                                <div class="__title">
                                                    В аналог казахстанского стартапа инвестируют Билл Гейтс и Марк
                                                    Цукерберг
                                                </div>

                                                <div class="__description">
                                                    Во всем мире с развитием высоких технологий предлагаются новые
                                                    форматы
                                                    использования
                                                    традиционных услуг...
                                                </div>
...
export default {
    ...
    mounted() {
        $(".main__purple__block_left_btn, .what_is__description a").click(function (e) {
            e.preventDefault();
